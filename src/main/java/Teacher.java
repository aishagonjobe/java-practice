//        Teacher class must implement methods
...
public class Teacher implements TeacherManual {
    ...
    public void createReports(){
        ...
        System.out.println("Please enter the student's name, surname, and grade");
        ...
        System.out.println("Student info: " + name + " " + surname + ", Grade: " + grade + ".");
    }
}
